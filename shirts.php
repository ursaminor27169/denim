...
<body>
    <?php
        ...
        $result = mysqli_query($link, "SELECT * FROM `shirts`");
        $number = mysqli_query($link, "SELECT count(id) FROM `shirts`");
        $ids = [];
        $titles = [];
        $imgs = [];
        $texts = [];
        $prices = [];
        $i = 0;
        while($shirts = mysqli_fetch_assoc($result)) 
        {
            $ids[$i] = $shirts['id'];
            $titles[$i] = $shirts['title'];
            $imgs[$i] = $shirts['img'];
            $texts[$i] = $shirts['text'];
            $prices[$i] = $shirts['price'];
            $i = $i + 1;
        }
    ?>
    <header>
        ...
        <div class="main">
            <div class="title">
                <ul class="bread-crumb">
                    ...
                    <li class="bread-crumb__unit"><a href="/man.html" class="bread-crumb__link">Man</a></li>
                    <li class="bread-crumb__unit">/</li>
                    <li class="bread-crumb__unit"><a href="#" class="bread-crumb__link bread-crumb__link_active">Shirts</a></li>
                </ul>
        ...
        <div class="assortments">
            <?php
                ...
                while ($i < count($titles)) {
                    echo
                    '<a href="/shirts-item.php/?id='. $ids[$i] .'" class="assortments-unit wow fadeInUp">
